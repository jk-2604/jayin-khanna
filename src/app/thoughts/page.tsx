...
export const metadata = {
  title: 'Philosophy Blog | Jayin Khanna',
  description: 'Jayin Khanna\'s personal blog on philosophy, AI, and life. Engage with thoughtful content and discussions.',
};
  ...
  return (
    <div className="container py-12 md:py-20">
      ...
      <div className="max-w-3xl mx-auto space-y-12">
        {blogPosts.map(post => (
          <Card key={post.slug} className="shadow-lg border-border hover:border-primary transition-all duration-300 hover:shadow-primary/20 overflow-hidden">
            <CardHeader>
