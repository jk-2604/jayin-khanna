...
export default function HomePage() { // <-- Remove async
  return (
    <div className="flex flex-col">
      ...
      <motion.section {...sectionAnimationProps} id="about-intro-section" className="container mx-auto min-h-screen flex flex-col justify-center">
        <AboutIntro />
      </motion.section>
      <Separator className="my-12 md:my-16 bg-border/40" />

      <motion.section {...sectionAnimationProps} id="education-section" className="container mx-auto min-h-screen flex flex-col justify-center">
        <AboutEducation />
      </motion.section>
      <Separator className="my-12 md:my-16 bg-border/40" />
      ...
      <motion.section {...sectionAnimationProps} id="collaborations-section" className="container mx-auto min-h-screen flex flex-col justify-center">
        <AboutCollaborations />
      </motion.section>
      <Separator className="my-12 md:my-16 bg-border/40" />
      ...
      <motion.section {...sectionAnimationProps} id="hobbies-section" className="container mx-auto min-h-screen flex flex-col justify-center">
        <AboutHobbies />
      </motion.section>
      <Separator className="my-12 md:my-16 bg-border/40" />

      <motion.section {...sectionAnimationProps} id="achievements-section" className="container mx-auto min-h-screen flex flex-col justify-center">
        <AboutAchievements />
      </motion.section>
    </div>
  );
