...
export const metadata = {
  title: 'Learning Vault | Jayin Khanna',
  description: 'A Zettelkasten-style collection of notes, articles, and insights by Jayin Khanna.',
};
        ...
        <main className="w-full md:w-3/4 lg:w-4/5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {articlesData.map(article => (
              <Card key={article.slug} className="shadow-lg border-border hover:border-primary transition-all duration-300 hover:shadow-primary/20">
                <CardHeader>
